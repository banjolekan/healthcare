    ...
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          <Text style={styles.cardTitle}>Chest -Ray</Text>
          <Text style={styles.date}>Last updated: Jan 02, 2020 by Dr. Kay Adeola</Text>
        </View>
        <Text style={styles.description}>Your chest is too wide...</Text>
        <Image source={require('./../assets/img.png')}/>
      </View>
  {/* 1*/}
  <View style={styles.card}>
        <View style={styles.cardHeader}>
          <Text style={styles.cardTitle}>CBC Test</Text>
          <Text style={styles.date}>Last updated: Jan 02, 2020 by Dr. Kay Adeola</Text>
        </View>
        <Text style={styles.description}>Your chest is too wide...</Text>
        <Image source={require('./../assets/img.png')}/>
      ...
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          <Text style={styles.cardTitle}>Hemoglobin A1C</Text>
          <Text style={styles.date}>Last updated: Jan 01, 2020 by Myself</Text>
        </View>
        <Text style={styles.description}>
        You are taking too much sugar, resulting to...
        </Text>
      </View>
