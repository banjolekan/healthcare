...
const OnlineappointScreen = ({ onBackPress }) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.navBar}>
        ...
        <View style={styles.actions}>
         <Text  style={{fontSize : 32, textAlign: 'center', justifyContent: 'center'}}>Online Appointment</Text>
         <Text> </Text>
          <TouchableOpacity>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.imageContainer}>
            <Image source={require('./../../assets/Ava3.png')} 
                style={styles.image}
              />
          ...
          <View style={styles.detailsContainer}>
            <Text style={styles.name}>Dr.Margaret Ochei</Text>
            <Text style={styles.profession}>Allergy & Immunology</Text>
        ...
        <View style={styles.contactSection}>
          ...
          <Text style={styles.infoText}>08:00 AM - 08:30 AM</Text>
          <Text style={styles.infoText}>Online Appointment: NGN4,500 / visit</Text>
        </View>
      ...
      />
        ...
        <View style={styles.contactSection}>
          ...
          <Image source={require('./../../assets/star.png')}
           ...
           <Text style={styles.infoText}>
           Dr. Margaret Ochei provides answers that are very helpful, knowledgeable, caring, professional and practical. Thank you so much for solving my problem.
          </Text>
...
export default OnlineappointScreen;
